...
namespace Mochizuki.ExtensionsLibrary.Runtime
{
    /// <summary>
    ...
    public class VersionManager
    {
        ...
        public string LatestVersion
        {
            get
            {
                ...
                if (_www.isNetworkError || _www.isHttpError)
                {
                    ...
                    Debug.Log($"[{_namespace}] Failed to fetch the remote version, set the latest version of {_repository} to 0.0.0.");
                    return _latestVersion;
                }
                ...
                Debug.Log($"[{_namespace}] Latest version of {_repository} is {_latestVersion}.");
                return _latestVersion;
            }
        }
        ...
        public VersionManager(string repository, string currentVersion, Regex format = null, string @namespace = "Mochizuki.ExtensionsLibrary.Runtime")
        {
        ...
        {
            Debug.Log($"[{_namespace}] Checking new version for {_repository}...");
